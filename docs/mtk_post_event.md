...
mmi_ret post_event_cb(mmi_event_struct *evt)
{
    MMI_ASSERT(123 == (int)evt->user_data);
    return 456;
}

mmi_ret post_event_result_cb(mmi_post_result_event_struct *result_evt)
{
    MMI_ASSERT(123 == (int)result_evt->evt_p->user_data);
    MMI_ASSERT(456 == result_evt->result);
    MMI_ASSERT(789 == (int)result_evt->user_data);
}
...
void hzwKeyHandler() {
    ...
    switch (keyCode) {
        ...
        case KEY_1: {
            ...
            mmi_frm_post_event(&evt, post_event_cb, 123);
            break;
        }
        ...
        case KEY_2: {
            mmi_event_struct evt;
            MMI_FRM_INIT_EVENT(&evt, 0);
            mmi_frm_post_event_ex(&evt, post_event_cb, 123, post_event_result_cb, 789);
        }
    }
}
