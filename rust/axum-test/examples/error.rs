...
// curl -H "Content-Type: application/json" -d '{"name": "hzw"}' localhost:3000/users
...
impl From<time_library::Error> for AppError {
    fn from(error: time_library::Error) -> Self {
        println!("From time_library::Error");
