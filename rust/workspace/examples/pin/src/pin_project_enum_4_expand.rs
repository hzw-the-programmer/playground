...
mod pin_project_enum_4 {
    ...
    #[pin(
        __private(
            project = FlattenProj,
            project_ref = FlattenProjRef,
            project_replace = FlattenProjOwn
        )
    )]
    ...
    pub(crate) enum FlattenProjRef<'pin, Fut1, Fut2>
    where
        Flatten<Fut1, Fut2>: 'pin,
    {
        First { f: ::pin_project::__private::Pin<&'pin (Fut1)> },
        Second { f: ::pin_project::__private::Pin<&'pin (Fut2)> },
        Empty,
    }
    #[allow(
        dead_code,
    ...
    pub(crate) enum FlattenProjOwn<Fut1, Fut2> {
        First { f: ::pin_project::__private::PhantomData<Fut1> },
        Second { f: ::pin_project::__private::PhantomData<Fut2> },
        Empty,
    }
    #[allow(
    ...
    const _: () = {
        ...
        impl<Fut1, Fut2> Flatten<Fut1, Fut2> {
            ...
            ) -> FlattenProjRef<'pin, Fut1, Fut2> {
                unsafe {
                    match self.get_ref() {
                        Self::First { f } => {
                            FlattenProjRef::First {
                                f: _pin_project::__private::Pin::new_unchecked(f),
                            }
                        }
                        Self::Second { f } => {
                            FlattenProjRef::Second {
                                f: _pin_project::__private::Pin::new_unchecked(f),
                            }
                        }
                        Self::Empty => FlattenProjRef::Empty,
                    }
                }
            }
            #[allow(dead_code)]
            ...
            pub(crate) fn project_replace(
                ...
                unsafe {
                    ...
                    match &mut *__self_ptr {
                        Self::First { f } => {
                            let __result = FlattenProjOwn::First {
                                f: _pin_project::__private::PhantomData,
                            };
                            {
                        ...
                        Self::Second { f } => {
                            let __result = FlattenProjOwn::Second {
                                f: _pin_project::__private::PhantomData,
                            };
                            {
                                let __guard = _pin_project::__private::UnsafeDropInPlaceGuard::new(
                        ...
                        Self::Empty => {
                            let __result = FlattenProjOwn::Empty;
                            {}
                            __result
                        }
                    }
...
use pin_project_enum_4 as test;
fn main() {
    test::test();
}
